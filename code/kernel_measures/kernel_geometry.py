...
#Note they reorder K1 and K2 in the appendix which is the convention we follow here.
#larger lam leads to smaller generalization geometric difference.
#THE ORDER OF THE INPUTS MATTERS. TO prepare gcq(Kc||Kq), K1=Kq and K2=Kc (appendix notation not main text notation.)
def geometric_difference(K1,K2,lam=0,tol=1e-3):
