...
sf=(0.5657 0.506 0.449 0.4166 0.3843 0.3541 0.3381 0.3222 0.3062 0.2902 0.2776 0.27 0.2624 0.2548 0.2472)
...
parallel \
    --jobs 15 \
    """
        python compute_Sparse_IQP_kernel_gennorm_data.py --outpath /nfs/gce/projects/gce/QK_project/results/Sparse_IQP/final_gennorm/beta1.0gamma0.8/ \
        --dataset-dim {2} \
        --scaling-factor {1} \
