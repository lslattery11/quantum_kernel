...
sf=(0.3069 0.2724 0.2497 0.2271 0.2129 0.2017 0.1905 0.1793 0.1712 0.1656 0.16 0.1544 0.1488 0.1432 0.1376)
...
parallel \
    --jobs 15 \
    """
        python compute_Sparse_IQP_kernel_gennorm_data.py --outpath /nfs/gce/projects/gce/QK_project/results/Sparse_IQP/final_gennorm/beta2.0gamma0.5/ \
        --dataset-dim {2} \
        --scaling-factor {1} \
